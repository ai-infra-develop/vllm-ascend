#!/usr/bin/env python3
"""Step 3: Load the commit log review system prompt and write it to a file."""

import argparse
from pathlib import Path

PROMPT_DIR = Path(__file__).resolve().parent / "commit_review_prompts"
...
def load_system_prompt() -> str:
    ...
    return "You are a commit message review assistant."
